...
def segmentChamber(videofile, dicomdir, view):
    ...
    if view == "a4c":
        ...
        with g_1.as_default():
            ...
            saver.restore(sess1,'../echocv/models/a4c_45_20_all_model.ckpt-9000')
    elif view == "a2c":
        g_2 = tf.Graph()
        with g_2.as_default():
            label_dim = 4 
        ...
        with g_2.as_default():
            saver = tf.train.Saver()
            saver.restore(sess2,'../echocv/models/a2c_45_20_all_model.ckpt-10600')
    elif view == "a3c":
        g_3 = tf.Graph()
        with g_3.as_default():
            label_dim = 4 
            ...
            model = model3
        with g_3.as_default():
            saver.restore(sess3,'../echocv/models/a3c_45_20_all_model.ckpt-10500')
    elif view == "psax":
        g_4 = tf.Graph()
        with g_4.as_default():
            label_dim = 4 
        ...
        with g_4.as_default():
            saver = tf.train.Saver()
            saver.restore(sess4,'../echocv/models/psax_45_20_all_model.ckpt-9300')
    elif view == "plax":
        g_5 = tf.Graph()
        with g_5.as_default():
            label_dim = 7 
        ...
        with g_5.as_default():
            saver = tf.train.Saver()
            saver.restore(sess5,'../echocv/models/plax_45_20_all_model.ckpt-9600')
...
# Sample code to dynamically populate viewdict based on the CSV header
import csv
        ...
        for line in csvFile:
            ...
            for view, col in viewdict.items():
                ...
                if float(line[idx]) > probthresh:
                    if view.endswith('_pap'):  # Just an example; adapt as needed
